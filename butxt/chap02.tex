...
Posledné 3 stĺpce teda predstavujú kurzy na dané výsledky. Tieto ale nie sú pri trénovaní siete využívané, a teda pre data, ktoré sú vždy použité len pre trénovanie ani nie sú vyžadujúce.
